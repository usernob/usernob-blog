<x-layouts.guest>
    ...
    <section class="container min-h-screen my-10">
        <div class="prose md:prose-lg dark:prose-invert mx-auto w-full max-w-[80ch] px-6">
            ...
            <ul>
                <li>👋 Halo, saya <span class="font-bold">Ramzi Pandu Ma'arif</span> aka usernob</li>
                <li>🔭 18 yo</li>
                <li>👀 Suka ngoding, ngegame ringan, kadang juga nonton anime</li>
                <li>🌱 Saat ini saya sedang belajar tentang laravel, rust, go</li>
                <li>🏫 Saat ini sekolah di SMKN 2 Trenggalek</li>
            </ul>

            <h2>Beberapa techstack yang saya gunakan</h2>
