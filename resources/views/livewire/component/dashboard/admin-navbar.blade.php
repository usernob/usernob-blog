<header class="bg-background2 shadow-b-md" x-data="{ open: false }">
    <aside class="absolute left-0 top-0 h-screen bg-background2 p-4" x-show="open" x-cloak
        ...
        <div class="relative">
            ...
            <svg x-show="open" x-cloak @click="open = false" x-transition.opacity xmlns="http://www.w3.org/2000/svg" fill="none"
