            ...
            <article class="group" wire:key="{{ $post->id }}">
                ...
                <div class="mt-4">
                    ...
                    <div class="flex flex-wrap items-center gap-1">
                        @foreach ($post->tag_relation()->get() as $tags)
                            <a href=""
                                class="text-xs font-semibold px-2 py-1 rounded-full bg-placeholder hover:bg-placeholder/50 transition">#{{ $tags->tag->name }}</a>
                        @endforeach
                    </div>
